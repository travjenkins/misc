...
# Test db stuff
# Eventually need to output IP for pgadmin4_container_wild_west and postgres_container_wild_west
#    .[0].Containers (something) .Name / IPv4Address
alias gtdb='cd ~/dbs/'
alias dbup='gtdb; docker-compose up -d; docker network inspect supabase_network_flow;'
